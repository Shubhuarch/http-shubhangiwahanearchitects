  ...
  return (
    <div className="container mx-auto px-4 py-8 w-full">
      ...
      <div className="w-full mx-auto flex justify-evenly flex-col md:flex-row">
        <form onSubmit={handleSubmit} className="space-y-4 md:w-[45%]">
          <div className="">
        ...
        <div className="md:w-[45%] p-4 mt-2 md:mt-0 md:bg-opacity-50 rounded-2xl ">
          ...
          <div className="md:w-[70%] md:pl-[9vh]">
            <div className="w-full flex m-2"><FaPhoneAlt /> <p className="pl-2">+91 0000000000</p> </div>
            <div className="w-full flex m-2"><IoMdMailUnread /><p className="pl-2">yourmail@gmail.com</p> </div>
            <div className="w-full flex m-2"><FaLocationDot /> <p className="pl-2">Some Address Here</p> </div>
          </div>
        </div>
      </div>
    </div>
